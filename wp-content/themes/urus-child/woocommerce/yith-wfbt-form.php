<?php
	...
	$discont_price = ((float)$total - (float)get_post_meta(get_the_ID(), 'number-price-discount', TRUE)) ;
?>
        ...
        <div class="block-right">
            <div class="yith-wfbt-submit-block">
                <div class="price_text">
                    ...
                    <?php echo '<span class="price-dicount-single-product">' . wc_price( $total ) . ' </span>'; ?>
                    <span class="total_price" data-total="<?php echo esc_attr($discont_price); ?>">
                        <?php echo '<span>' . wc_price( $discont_price ) . ' </span>'; ?>
                    </span>
                </div>
                <input type="submit" class="yith-wfbt-submit-button button border" value="<?php echo esc_html( $label ); ?>">
            </div>
            <?php echo '<span class="saving-cost">Uštedeli ste: ' . wc_price( $total-$discont_price ) . '</span>'; ?>
        </div>
